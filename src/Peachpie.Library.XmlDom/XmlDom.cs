...
namespace Peachpie.Library.XmlDom
{
    ...
    public static class XmlDom
    {
        ...
        /// </summary>
        public const int DOM_INDEX_SIZE_ERR = (int)DOMException.ExceptionCode.IndexOutOfBounds;

        /// <summary>
        /// The specified range of text does not fit into a string.
        /// </summary>
        public const int DOMSTRING_SIZE_ERR = (int)DOMException.ExceptionCode.StringTooLong;

        /// <summary>
        /// A node is inserted somewhere it doesn't belong.
        /// </summary>
        public const int DOM_HIERARCHY_REQUEST_ERR = (int)DOMException.ExceptionCode.BadHierarchy;

        /// <summary>
        /// A node is used in a different document than the one that created it.
        /// </summary>
        public const int DOM_WRONG_DOCUMENT_ERR = (int)DOMException.ExceptionCode.WrongDocument;

        /// <summary>
        /// An invalid or illegal character is specified, such as in a name.
        /// </summary>
        public const int DOM_INVALID_CHARACTER_ERR = (int)DOMException.ExceptionCode.InvalidCharacter;

        /// <summary>
        /// Data is specified for a node which does not support data.
        /// </summary>
        public const int DOM_NO_DATA_ALLOWED_ERR = (int)DOMException.ExceptionCode.DataNotAllowed;

        /// <summary>
        /// An attempt is made to modify an object where modifications are not allowed.
        /// </summary>
        public const int DOM_NO_MODIFICATION_ALLOWED_ERR = (int)DOMException.ExceptionCode.DomModificationNotAllowed;

        /// <summary>
        /// An attempt is made to reference a node in a context where it does not exist.
        /// </summary>
        public const int DOM_NOT_FOUND_ERR = (int)DOMException.ExceptionCode.NotFound;

        /// <summary>
        /// The implementation does not support the requested type of object or operation.
        /// </summary>
        public const int DOM_NOT_SUPPORTED_ERR = (int)DOMException.ExceptionCode.NotSupported;

        /// <summary>
        /// An attempt is made to add an attribute that is already in use elsewhere.
        /// </summary>
        public const int DOM_INUSE_ATTRIBUTE_ERR = (int)DOMException.ExceptionCode.AttributeInUse;

        /// <summary>
        /// An attempt is made to use an object that is not, or is no longer, usable.
        /// </summary>
        public const int DOM_INVALID_STATE_ERR = (int)DOMException.ExceptionCode.InvalidState;

        /// <summary>
        /// An invalid or illegal string is specified.
        /// </summary>
        public const int DOM_SYNTAX_ERR = (int)DOMException.ExceptionCode.SyntaxError;

        /// <summary>
        /// An attempt is made to modify the type of the underlying object.
        /// </summary>
        public const int DOM_INVALID_MODIFICATION_ERR = (int)DOMException.ExceptionCode.ModificationNotAllowed;

        /// <summary>
        /// An attempt is made to create or change an object in a way which is incorrect with
        /// regard to namespaces.
        /// </summary>
        public const int DOM_NAMESPACE_ERR = (int)DOMException.ExceptionCode.NamespaceError;

        /// <summary>
        /// A parameter or an operation is not supported by the underlying object.
        /// </summary>
        public const int DOM_INVALID_ACCESS_ERR = (int)DOMException.ExceptionCode.InvalidAccess;
        ...
        /// </summary>
        public const int DOM_VALIDATION_ERR = (int)DOMException.ExceptionCode.ValidationError;
