    ...
    public static class CURLConstants
    {
        ...
        internal static void VerboseOutput(this CURLResource ch, string message)
        {
            if (ch.Verbose)
            {
                ...
                {
                    ch.VerboseOutput.WriteLine(message);
                }
                else
                {
        ...
        public void PrintCookies(Context ctx, CURLResource resource)
        {
            ...
            if (output != null)
            {
                try
                {
                    ...
                    output.WriteLine("# https://curl.haxx.se/docs/http-cookies.html");
                    output.WriteLine("# This file was generated by PeachPie! Edit at your own risk.");
                    output.WriteLine();
