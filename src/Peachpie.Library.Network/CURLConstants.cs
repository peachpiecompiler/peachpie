        ...
        public void PrintCookies(Context ctx, CURLResource resource)
        {
            ...
            if (output != null)
            {
                ...
                using (var writer = new StreamWriter(output, Encoding.ASCII)) {
                    ...
                    writer.Write(String.Join(Environment.NewLine, new string[] {
                        "# Netscape HTTP Cookie File",
                        "# https://curl.haxx.se/docs/http-cookies.html",
                        "# This file was generated by Peach Pie! Edit at your own risk.",
                        "",
                        ""
                    }));

                    // output the cookies in netscape style:
                    foreach (var line in CURLFunctions.CookiesToNetscapeStyle(resource.Result?.Cookies))
                    {
