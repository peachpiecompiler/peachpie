...
namespace Pchp.CodeAnalysis.Semantics
{
    ...
    internal static class VariableReferenceExtensions
    {
        ...
        public static LhsStack EmitStorePreamble(this IPlace place, CodeGenerator cg, BoundAccess access)
        {
            ...
            if (type == cg.CoreTypes.PhpValue && place.HasAddress && !access.IsWriteRef && !access.IsUnset) // TODO: only if target might be PhpAlias !
            {
    ...
    class FieldReference : IVariableReference
    {
        ...
        public IPlace Place
        {
            get
            {
                ...
                if (Receiver is BoundReferenceExpression bref && bref.Place(null) is IPlace receiver_place && receiver_place.Type.IsOfType(Field.ContainingType))
        ...
        public LhsStack EmitStorePreamble(CodeGenerator cg, BoundAccess access)
        {
            ...
            return VariableReferenceExtensions.EmitReceiver(cg, ref lhs, Field, Receiver) + new FieldPlace_Raw(Field, cg.Module).EmitStorePreamble(cg, access);
        }
    ...
    class PropertyReference : IVariableReference
    {
        ...
        public IPlace Place
        {
            get
            {
                ...
                if (Receiver is BoundReferenceExpression bref && bref.Place(null) is IPlace receiver_place && receiver_place.Type.IsOfType(Property.ContainingType))
