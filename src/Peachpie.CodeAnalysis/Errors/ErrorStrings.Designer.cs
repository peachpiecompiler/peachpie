...
namespace Pchp.CodeAnalysis.Errors {
    ...
    public class ErrorStrings {
        ...
        /// <summary>
        ///    Looks up a localized string similar to Type name &apos;{1}&apos; could not be resolved. It is either not defined, defined conditionally or ambiguous declarations were found..
        /// </summary>
